              ...
              <div data-oid="p0iv.oj" className="space-y-4">
                <div>
                  ...
                  <div className="text-xs text-gray-500 mt-1 space-y-1">
                    ...
                    <div className="pl-2">
                      <p>• OpenAI API: <code className="bg-gray-100 px-1 rounded">https://api.openai.com/v1</code></p>
                      <p>• Groq API: <code className="bg-gray-100 px-1 rounded">https://api.groq.com/v1</code></p>
                    </div>
                    <p className="text-amber-600">注意：不要在地址末尾添加额外的路径</p>
                  </div>
                </div>
                <div>
                  <label
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                    placeholder="例如：gpt-3.5-turbo 或 mixtral-8x7b-32768"
                  />
                  <div className="text-xs text-gray-500 mt-1 space-y-1">
                    <p className="font-medium">常用模型：</p>
                    <div className="pl-2">
                      <p>• OpenAI: <code className="bg-gray-100 px-1 rounded">gpt-3.5-turbo</code>, <code className="bg-gray-100 px-1 rounded">gpt-4-turbo-preview</code></p>
                      <p>• Groq: <code className="bg-gray-100 px-1 rounded">mixtral-8x7b-32768</code></p>
                    </div>
                    <p className="text-amber-600">提示：需要根据所选 API 设置对应的模型</p>
                  </div>
                </div>
                <div>
                  <label
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                    placeholder="输入你的 OpenAI 或 Groq API Key"
                    data-oid="uejzdqn"
                  />
                </div>
                <div>
